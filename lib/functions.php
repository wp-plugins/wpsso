...
if ( ! function_exists( 'wpsso_get_social_buttons' ) ) {
	function wpsso_get_social_buttons( $ids = array(), $atts = array() ) {
		return wpsso_get_sharing_buttons( $ids, $atts );
	}
}

if ( ! function_exists( 'wpsso_get_sharing_buttons' ) ) {
	function wpsso_get_sharing_buttons( $ids = array(), $atts = array() ) {
		global $wpsso;
