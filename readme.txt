...
<p>WordPress Social Sharing Optimization (WPSSO) <strong>gives you total control over information social websites need</strong>, improving Google Search ranking, social engagement, and click-through-rates on Facebook, Google+, Twitter, LinkedIn, Pinterest, StumbleUpon, Tumblr and and many more &mdash; no sharing buttons required!</p>

<p>Use WPSSO on its own, in combination with sharing button plugins, or extend and improve an existing SEO solution.</p>
