...
<p><u>It's the HTML meta tags that provide information about your content, not the sharing buttons</u>. <strong>Make sure social websites present your content in the best possible way, no matter <em>how</em> your webpage is shared</strong> &mdash; from sharing buttons on the webpage, browser add-ons and extensions, or URLs pasted directly on social websites.</p>
</blockquote>
