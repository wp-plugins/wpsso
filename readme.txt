...
<p><strong>Already using social sharing buttons?</strong> No problem! <em>Sharing buttons only submit URLs to social websites</em> &mdash; WPSSO can then provides all the information those social websites need to know about your shared content. Use WPSSO by itself, or in combination with any of your favorite social sharing buttons.</p>
...
* **Enhancements**
	...
	* Added a new 'WPSSO_META_SAVE_PRIORITY' constant (with a default value of 20).
