...
<p><img src="https://ps.w.org/wpsso/assets/icon-256x256.png?rev=" width="256" height="256" style="width:33%;min-width:128px;max-width:256px;float:left;margin:0 40px 20px 0;" />
<strong>Make sure social websites present your content in the best possible way, no matter <em>how</em> your webpage is shared</strong> &mdash; from sharing buttons on the webpage, browser add-ons and extensions, or <em>URLs pasted directly in social timeline posts and private messages</em>.</p>
...
<img src="https://ps.w.org/wpsso/assets/screenshot-22.png?rev=" width="607" height="650" style="width:40%;min-width:256px;max-width:607px;float:right;margin:0 0 20px 40px;" />
...
<img src="https://ps.w.org/wpsso/assets/screenshot-23.png?rev=" width="1024" height="594" style="width:40%;min-width:256px;max-width:1024px;float:right;margin:0 0 20px 40px;" />
